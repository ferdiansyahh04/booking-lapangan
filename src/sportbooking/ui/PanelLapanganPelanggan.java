...
public class PanelLapanganPelanggan extends JPanel {
        ...
        table.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (row >= 0) {
                    ...
                    lblInfo.setText("Lapangan dipilih: " + tableModel.getValueAt(row, 1));
                } else {
                    btnBooking.setEnabled(false);
                    lblInfo.setText("Pilih lapangan lalu klik Booking");
                }
            }
        });
    ...
    public void refreshData() {
        ...
        for (Lapangan lap : list) {
            ...
            if ("Tersedia".equalsIgnoreCase(lap.getStatus())) {
                tersedia++;
            }
        }

        lblInfo.setText(String.format(
                "Total: %d lapangan | %d tersedia | Pilih lapangan lalu klik Booking",
                list.size(), tersedia));
